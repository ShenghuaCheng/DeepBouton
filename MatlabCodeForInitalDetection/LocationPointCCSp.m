function pointStruct = LocationPointCCSp(initialInd, connectedCImg, tempPixelList, thetaGauss, volumeThre, minR, selectThre, localInd1, localInd2, localSize, localNum)
